...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        MortarRecipeBuilder.builder()
                ...
                // Save
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "glass_powder_full_recipe"));
        ...
        MortarRecipeBuilder.builder()
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "glass_powder_from_shattered"));
        ...
        MortarRecipeBuilder.builder()
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "silica_from_sands"));
        ...
        MortarRecipeBuilder.builder()
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "silica_from_quartz"));
        ...
        MortarRecipeBuilder.builder()
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "glass_shatter_from_block"));
        ...
        MortarRecipeBuilder.builder()
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "blaze_powder_from_mortar"));
        ...
        MortarRecipeBuilder.builder()
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath("ph_and_co", "gunpowder_from_sulfur"));
